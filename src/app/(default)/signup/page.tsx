        ...
        <div className="md:pt-6">
                <Link href="/">
                    <div className='w-1/2 flex items-center gap-2'>
                        ...
                        <h3 className='text-xl md:text-2xl text-primary font-semibold'>Ilemi.<span className='text-lg text-primary'>ng</span></h3>
                    </div>
                </Link>
            ...
            <div className="lg:-mt-24 mt-12 px-3 md:h-full md:max-h-full w-full md:flex flex-col items-center justify-center">
                <h2 className='text-xl font-semibold'>How would you like to Join <span className='text-primary-500'>Ilemi?</span></h2>
                <div className='md:border border-[#B1B7D6] md:px-10 py-6 w-full md:w-[30rem] my-4 rounded-xl'>
                    <div className="w-full flex flex-col gap-5">
                        <div>
                            <div className="flex items-center gap-4 my-3">
                                <span className='h-10 w-10 flex items-center justify-center text-white rounded-full bg-primary-600'>
                            ...
                            <Link href="/create-account?account=onile">
                                <button className="py-3 px-6 border-2 border-primary text-sm text-primary rounded-3xl cursor-pointer">Continue as landlord</button>
                            </Link>
                            </div>
                        </div>
                    ...
                    <div className="border-b"></div>
                        ...
                        <div>
                            ...
                            <div className="mt-6">
                                <button className="py-3 px-6 border-2 border-[#00A45D] text-sm text-[#00A45D] rounded-3xl">Continue as a tenant</button>
                            </div>
                        </div>
                ...
                <p className='text'>Have an account? <Link href="/login" className='text-primary'>Sign In</Link></p>
            </div>
        </div>
        </div>
